...
namespace Content.Server.Corvax.StationGoal
{
    ...
    public sealed partial class StationGoalPaperSystem : EntitySystem
    {
        ...
        private static readonly string BaseNTLogo =
            ...
            [color=#1b487e]░░░░██░░░████░███[/color]
            ═════════════════════════════════════════
                      [bold]ПРИКАЗ О НАЗНАЧЕНИИ ЦЕЛИ[/bold]
            ═════════════════════════════════════════
            Дата: { $date }

            Уважаемое командование станции, минимальными задачами вашей смены для каждого из действующих отделов станции являются:
        ...
        private static readonly string BaseEndOfGoal =
            ...
            Примечания:
            - Любое повышение продуктивности станции приветствуется и вознаграждается надбавкой к зарплате ответственных за него сотрудников.
            - Главам отделов рекомендуется постановка дополнительных целей своим подчиненным. Учтите, что поставленные задачи и отчет об их выполнении должны быть задокументированы и доставлены на СЦК.
            - Развлекательные/культурные мероприятия по инициативе экипажа вознаграждаются надбавкой к зарплате при предоставлении ЦК фото-/видеоотчета об их проведении.
            - Вы всегда имеете право вызвать эвакуационный шаттл, если:
                - станция стала непригодной для пребывания.
                - прошло более двух часов и тридцати минут от начала смены.
        ...
        private static readonly string BaseOfGoal =
            """
            [bold]НИО:[/bold] Закрытие нормы научных исследований (нормой считается количество “очков”, необходимое для открытия всех технологий в консоли исследований).
            [bold]СБ:[/bold] Обеспечение безопасности объекта.
            [bold]СНАБ:[/bold] Материальное обеспечение станции и закрытие ресурсных потребностей ее отделов в течение смены.
            [bold]ИНЖ:[/bold] Поддержание станции в работоспособном состоянии в течение смены.
            [bold]МЕД:[/bold] Своевременное медицинское обслуживание экипажа в течение смены.
            [bold]СЕРВ:[/bold] Обеспечение экипажа станции услугами рекреационного характера.
            [bold]КОМ:[/bold]
              1. Поддержание работы станции в течение минимум двух с часов и тридцати минут. Исключением являются ситуации, требующих немедленной эвакуации экипажа.
              2. Повышение производительности станции и оптимизация работы отделов.
        ...
        public bool SendStationGoal(StationGoalPrototype goal)
        {
            ...
            while (enumerator.MoveNext(out var uid, out var fax))
            {
                ...
                var goalContent = FormatStringToGoalContent(BaseNTLogo + BaseOfGoal + BaseEndOfGoal, stationString);
