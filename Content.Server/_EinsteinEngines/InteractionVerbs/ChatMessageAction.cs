...
public sealed partial class ChatMessageAction : InteractionAction
{
    ...
    [DataField]
    public InGameICChatType ChatType = InGameICChatType.Emote;
    ...
    public override bool Perform(InteractionArgs args, InteractionVerbPrototype proto, VerbDependencies deps)
    {
        ...
        var chatSystem = deps.EntMan.System<ChatSystem>();
        chatSystem.TrySendInGameICMessage(speaker, message, ChatType, false);
