    ...
    public sealed partial class HealthAnalyzerWindow : FancyWindow
    {
        ...
        public void Populate(HealthAnalyzerScannedUserMessage msg)
        {
            ...
            if (msg.WoundableData is { } woundable)
            {
                ...
                SpO2Label.Text = Loc.GetString("health-analyzer-window-entity-spo2-value", ("value", $"{woundable.Spo2 * 100:F1}"), ("rating", woundable.Spo2Rating));
                ...
                EtCO2Label.Text = Loc.GetString("health-analyzer-window-entity-etco2-value", ("value", $"{woundable.Etco2}"), ("rating", woundable.Etco2Rating));
