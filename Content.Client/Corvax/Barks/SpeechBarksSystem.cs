...
namespace Content.Client.Corvax.Barks;
...
public sealed partial class SpeechBarksSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        _cfg.OnValueChanged(CCCVars.BarksVolume, OnVolumeChanged, true);
        _cfg.OnValueChanged(CCCVars.SpeechMode, OnSpeechModeChanged, true);
    ...
    {
        StopPreview();
        _cfg.UnsubValueChanged(CCCVars.BarksVolume, OnVolumeChanged);
        _cfg.UnsubValueChanged(CCCVars.SpeechMode, OnSpeechModeChanged);
        _active.Clear();
        base.Shutdown();
    }
