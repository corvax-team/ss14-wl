            ...
            Control label)
        {
            ...
            foreach (var skill in skills)
            {
                    ...
                    skill < limitation.MinSkillLevel))
                {
                    ...
                    button.ToolTip = "Уровень навыка недоступен из-за лорных соображений.";
                }
            }
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        public void RefreshAntags()
        {
            ...
            foreach (var antag in _prototypeManager.EnumeratePrototypes<AntagPrototype>().OrderBy(a => Loc.GetString(a.Name)))
            {
                ...
                selector.Setup(items, new Label() { Text = title, ToolTip = description }, 250);
        ...
        public void RefreshJobs()
        {
            ...
            foreach (var department in departments)
            {
                ...
                foreach (var job in jobs)
                {
                    ...
                    selector.Setup(items, subnameSelector, 200, icon);
