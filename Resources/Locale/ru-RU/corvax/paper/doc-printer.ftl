...
doc-text-printer-search-permission =
    ...
    =============================================
                                ⠀[italic]Место для печатей[/italic]
doc-text-printer-setting-of-goal =
    ⠀[color=#1b487e]███░███░░░░██░░░░[/color]
    ⠀[color=#1b487e]░██░████░░░██░░░░[/color]      [head=3]Бланк документа[/head]
    ⠀[color=#1b487e]░░█░██░██░░██░█░░[/color]               [head=3]NanoTrasen[/head]
    ⠀[color=#1b487e]░░░░██░░██░██░██░[/color] [bold]:СТАНЦИЯ: СБ[/bold]
    ⠀[color=#1b487e]░░░░██░░░████░███[/color]
    =============================================
			[bold]ПРИКАЗ ГЛАВЫ О НАЗНАЧЕНИИ ЦЕЛИ[/bold]
    =============================================
    Время от начала смены и дата: :ДАТА:
    Составитель документа: :ФИО:
    Должность составителя: :ДОЛЖНОСТЬ:

    Я, :ФИО:, в должности :ДОЛЖНОСТЬ:, приказываю (полное наименование отдела) организовать выполнение следующих задач:

    Критерии выполнения:

    Срок выполнения или отчёта:
