interaction-verb-invalid = Требования для этого действия не выполнены. Вы не можете использовать это сейчас.
interaction-verb-cooldown = Это действие на перезарядке. Подождите {TOSTRING($seconds, "F1")} seconds.
