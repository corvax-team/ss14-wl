...
ent-ClothingHeadHatBeretRobotech = берет роботехника
    .desc = Этот берет прямо кричит, что ты только не только не такой, как остальные коллеги в научном отделе, но знаешь, что такое машинное масло.

ent-ClothingHeadHatBeretAtmos = берет адъютанта центком
